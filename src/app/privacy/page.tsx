...
export default function PrivacyPage() {
  const body =
    "text-sm leading-6 text-dark md:text-base md:leading-7";

  return (
    <div className="rounded-b-[36px] bg-white">
      <div className="container flex flex-col gap-14 py-10 md:gap-20 md:py-14">
        {/* Heading */}
        ...
        {/* ── Body content ── */}
        <div className={`flex flex-col gap-10 ${body}`}>
          {/* ── Intro ── */}
          <section className="flex flex-col gap-4">
            <p>
              This Privacy Notice for Transit Stats (&ldquo;we,&rdquo;
            ...
            <ul className="flex flex-col gap-1">
              <li>
                Download and use our mobile application (Transit Stats), or any
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              provider, as described in the section called &ldquo;HOW DO WE
              HANDLE YOUR SOCIAL LOGINS?&rdquo; below.
            </p>
            <p>
            ...
            <p>
              ...
              called &ldquo;crash dumps&rdquo;), and hardware settings).
            </p>
            <p>
            ...
            <h3 className="mt-4 font-semibold">Google API</h3>
            <p>
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              and cell towers to estimate your location. GPS is accurate to about
              20 meters, while Wi-Fi and cell towers help improve accuracy when
              ...
              obtain and store on your device (&ldquo;cache&rdquo;) your
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              link towards a third-party website, service, or application does
          ...
          <section className="flex flex-col gap-4">
            ...
            <p>
              ...
              section &ldquo;DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY
              RIGHTS?&rdquo;
            </p>
            <p>
            ...
            <h3 className="mt-4 font-semibold">Google Analytics</h3>
            <p>
          ...
          <section className="flex flex-col gap-4">
            <h2 className="font-bold">10. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
            <p>
            ...
            <p>
              ...
              US ABOUT THIS NOTICE?&rdquo; below.
            </p>
            <p>
            ...
            <h3 className="mt-4 font-semibold">Account Information</h3>
            <p>
          ...
          <section className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-3 pl-4">
              <li>
                <strong>A. Identifiers</strong> — Contact details, such as real
                ...
                address, email address, and account name — NOT COLLECTED
              </li>
              <li>
                <strong>
                ...
                history, and financial information — NOT COLLECTED
              </li>
              <li>
                <strong>
                ...
                origin, marital status, and other demographic data — NOT
                COLLECTED
              </li>
              <li>
                <strong>D. Commercial information</strong> — Transaction
                information, purchase history, financial details, and payment
                information — NOT COLLECTED
              </li>
              <li>
                <strong>E. Biometric information</strong> — Fingerprints and
                voiceprints — NOT COLLECTED
              </li>
              <li>
                <strong>
                ...
                systems, and advertisements — NOT COLLECTED
              </li>
              <li>
                <strong>G. Geolocation data</strong> — Device location —
                COLLECTED
              </li>
              <li>
                <strong>
              ...
              <li>
                <strong>J. Education Information</strong> — Student records and
                directory information — NOT COLLECTED
              </li>
              <li>
                <strong>
                ...
                an individual&rsquo;s preferences and characteristics — NOT
                COLLECTED
              </li>
              <li>
                <strong>L. Sensitive personal Information</strong> — NOT
                COLLECTED
              </li>
            </ul>
            <p>
            ...
            <p>
              ...
              information to in the section, &ldquo;WHEN AND WITH WHOM DO WE
              SHARE YOUR PERSONAL INFORMATION?&rdquo;
            </p>
            <p>
            ...
            <h3 className="mt-4 font-semibold">How to Exercise Your Rights</h3>
            <p>
            ...
            <h3 className="mt-4 font-semibold">Request Verification</h3>
            <p>
            ...
            <h3 className="mt-4 font-semibold">Appeals</h3>
            <p>
