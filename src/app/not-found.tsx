  ...
  return (
    <div className="rounded-b-[36px] bg-white">
      <div className="mx-auto flex min-h-[60vh] max-w-2xl flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <Link
          href="/"
          className="mt-8 rounded-full bg-brand px-8 py-3 text-sm font-semibold text-white transition-all duration-200 hover:brightness-110 active:scale-[0.97] md:text-base"
        >
          Back to home
        </Link>
      </div>
