      ...
      >
        ...
        <Link href="/" aria-label="Transit Stats home" className="shrink-0">
          <Image
            ...
            width={205}
            height={32}
            className={`h-auto w-[149px] lg:w-[205px] transition-all duration-300 ${mobileOpen ? "brightness-0 invert md:brightness-100 md:invert-0" : ""}`}
            priority
          />
        </Link>
        ...
        <button
          type="button"
          className={`rounded-md p-2 md:hidden transition-colors duration-300 ${mobileOpen ? "text-white" : "text-brand"}`}
